...
As part of its operations, Acme Corp collects and processes information. This includes any offline or online data that makes a person identifiable, such as names, addresses, usernames and passwords, digital footprints, photographs, financial data, and other personal details.
...
*   **Fair Collection and Lawful Purposes:** Data will be collected fairly and only for lawful purposes.
...
*   **Restricted Transfer:** Data will not be transferred to organizations, states, or countries that do not have adequate data protection policies.
*   **Controlled Distribution:** Data will not be distributed to any party other than those agreed upon by the data's owner, exempting legitimate requests from law enforcement authorities.

In addition to data handling practices, Acme Corp has direct obligations towards the individuals to whom the data belongs:

*   **Notification of Collection:** We will inform individuals which of their data is collected.
*   **Transparency in Processing:** We will inform individuals about how we will process their data.
*   **Disclosure of Access:** We will inform individuals about who has access to their information.
...
Our data protection provisions will be clearly communicated and accessible to all relevant parties.
